  ...
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
        {featuresData.map((feature: IFeature, index: number) => (
          <motion.div
            ...
            className={`${
              index === 1
                ? "p-px rounded-[13px] bg-linear-to-br from-orange-600 to-slate-800"
                : ""
            }`}
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        >
          Powered by viral intelligence, our AI creates thumbnails that drive
          engagement. Designed by AI. Optimized for virality.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            ...
            <p className="text-slate-300 mt-2">
              Turn data into clicks with thumbnails crafted by intelligent AI.
